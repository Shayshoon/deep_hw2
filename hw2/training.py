        ...
        **kw,
        ...
        for epoch in range(num_epochs):
            ...
            if best_acc is None or test_result.accuracy > best_acc:
                ...
                # ====== YOUR CODE: ======
                no_improvement += 1
                if early_stopping is not None and early_stopping <= no_improvement:
                    break
                # ========================
...
class ClassifierTrainer(Trainer):
    ...
    def train_batch(self, batch) -> BatchResult:
        ...
        # 2. Forward pass (get raw scores/probabilities for loss)
        ...
        # 5. Record loss and calculate accuracy
        batch_loss = loss.item()
        
        # We use the model's classify method to get the hard labels (0 or 1, or class IDs)
...
class LayerTrainer(Trainer):
    ...
    def train_batch(self, batch) -> BatchResult:
        ...
        out = self.model.forward(flattened_X)
        ...
        y_pred = out.argmax(1)
        num_correct = len(y_pred[y == y_pred])
        # ========================
